...
required_packages = c(
  # installs dplyr, ggplot, and other libraries in the tidy universe
  "tidyverse",
  # Plotting extras
  "ggrepel", "RColorBrewer",
  # nifty utililties
  "here", "sessioninfo", 
  # These last few are not strictly necessary for the workshop curriculum - but it might come up in a question. 
