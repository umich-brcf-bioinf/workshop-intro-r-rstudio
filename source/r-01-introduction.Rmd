...
To get started, we'll go to [http://bfx-workshop01.med.umich.edu](http://bfx-workshop01.med.umich.edu)

The login page for the server looks like:

<img src="images/01_rstudio_login_screen.jpeg" alt="rstudio login screen" style="width: 1000px;"/>

Enter your user credentials and click <kbd>Sign In</kbd>. The RStudio interface should load and look like:

<img src="images/02_rstudio_session_default.jpeg" alt="rstudio default session" style="width:1000px;"/>
...
- The Console pane along the left where you can enter commands an execute them.
...
When first opening RStudio, there is no pane to write code to save as a file. But by clicking on the icon in the upper-right-most of the interface (a blank piece of paper with a + sign), and selecting <KBD>R Script</KBD> a new pane opens. This last pane is the Source (or Script) pane, and it is here that we'll keep a running record of the commands we learn in this workshop.

<img src="images/03_rstudio_script_pane.jpeg" alt="rstudio script pane" style="width:1000px;"/>

**Checkpoint**

## Commands in the Console

We can input commands directly into the Console (now the lower left pane) and press <KBD>Enter</KBD> to execute them. Try it with:
...
To keep that record, we will enter our commands in the Script pane, and then send them to the Console for execution. In the Script pane, enter:

~~~
3+2
~~~

<img src="images/04_rstudio_code_in_script.jpeg" alt="rstudio code in script" style="width:1000px;"/>
...
<img src="images/05_rstudio_code_execution.jpeg" alt="rstudio code execution" style="width:1000px;"/>

> ## Note: Script Pane and Console Pane
>
> The code written in the Script Pane is inert until it is executed with <KBD>Control + Enter</KBD>. The Console Pane is the record of the code that has been executed.
<br>
...
<img src="images/06_rstudio_soft_wrap.jpeg" alt="rstudio code execution" style="width:1000px;"/>
