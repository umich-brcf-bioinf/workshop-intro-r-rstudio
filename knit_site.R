...
#render('source/workshop_setup/setup-aws/setup_instructions.Rmd', output_dir='html/workshop_setup/')
render('source/workshop_setup/setup-positcloud/setup_instructions.Rmd', output_dir='html/workshop_setup/')
